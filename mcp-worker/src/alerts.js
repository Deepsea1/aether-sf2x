...
export function normalizeVerification(input) {
  ...
  return {
    ...
    trustScore,
    truthStatus: asTrimmedString(body.truth_status) || null,
    evidenceBasis: asTrimmedString(body.evidence_basis) || null,
    proofLevel: asTrimmedString(body.proof_level) || null,
    integrityStatus: asTrimmedString(body.integrity_status) || null,
    actionAuthorization: asTrimmedString(body.action_authorization) || null,
